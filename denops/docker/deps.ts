...
export { isString } from "https://deno.land/x/unknownutil@v2.1.1/mod.ts";
...
export * as mapType from "https://deno.land/x/denops_std@v4.1.7/mapping/types.ts";
export * as vars from "https://deno.land/x/denops_std@v4.1.7/variable/mod.ts";
...
export { Buffer } from "https://deno.land/std@0.186.0/io/buffer.ts";

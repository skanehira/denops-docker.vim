...
export { assertEquals } from "https://deno.land/std@0.169.0/testing/asserts.ts";
export { BufReader } from "https://deno.land/std@0.169.0/io/buffer.ts";
export { TextProtoReader } from "https://deno.land/std@0.169.0/textproto/mod.ts";
...
export * as path from "https://deno.land/std@0.169.0/path/mod.ts";
export * as fs from "https://deno.land/std@0.169.0/fs/mod.ts";
export { open } from "https://deno.land/x/open@v0.0.5/index.ts";
export * as io from "https://deno.land/std@0.169.0/io/buffer.ts";

...
export * as mapping from "https://deno.land/x/denops_std@v5.3.0/mapping/mod.ts";
export * as mapType from "https://deno.land/x/denops_std@v5.3.0/mapping/types.ts";
export * as vars from "https://deno.land/x/denops_std@v5.3.0/variable/mod.ts";
...
export { Buffer } from "https://deno.land/std@0.214.0/io/buffer.ts";

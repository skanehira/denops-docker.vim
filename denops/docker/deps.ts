export * from "https://deno.land/x/denops_std@v3.12.2/mod.ts";
...
export * as mapping from "https://deno.land/x/denops_std@v3.12.2/mapping/mod.ts";
export * as mapType from "https://deno.land/x/denops_std@v3.12.2/mapping/types.ts";
